    ...
    <div className="flex flex-row justify-between items-center">
      <div className="flex flex-col justify-center">
        <div>
          ...
          <div className="pt-10 grid md:grid-cols-3 gap-x-4">
            <div>
              <button
                onClick={onContactClick}
                className="bg-primary text-bg-light dark:text-bg-dark text-2xl inline-block px-8 py-4 my-2 rounded-lg font-semibold"
              >
                Contact Me
              </button>
            </div>
      ...
      <img className="hidden xl:block" src="/dev.svg" alt="dev" />
    </div>
  );
}
